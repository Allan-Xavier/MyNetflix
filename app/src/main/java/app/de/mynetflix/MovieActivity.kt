...
import app.de.mynetflix.model.Movie
import app.de.mynetflix.model.MovieDetail
import app.de.mynetflix.util.DownloadImageTask
import app.de.mynetflix.util.MovieTask
...
class MovieActivity : AppCompatActivity(), MovieTask.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "https://atway.tiagoaguiar.co/fenix/netflixapp/$id?apiKey=81bb7fb8-5b47-43bf-a074-4438e54ca67d"
